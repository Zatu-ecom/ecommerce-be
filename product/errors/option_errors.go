...
var (
	...
	ErrProductOptionNotFound = &AppError{
	...
	ErrProductOptionNameExists = &AppError{
	...
	ErrProductOptionInUse = &AppError{
	...
	ErrProductOptionValueNotFound = &AppError{
	...
	ErrProductOptionValueInUse = &AppError{
	...
	ErrProductOptionValueExists = &AppError{
	...
	ErrProductOptionMismatch = &AppError{
	...
	ErrProductOptionValueMismatch = &AppError{
