...
var (
	...
	ErrProductExists = &commonError.AppError{
	...
	ErrProductNotFound = &commonError.AppError{
	...
	ErrProductSKUExists = &commonError.AppError{
	...
	ErrInvalidCategory = &commonError.AppError{
	...
	ErrInvalidAttributes = &commonError.AppError{
		Code:       utils.PRODUCT_ATTRIBUTES_INVALID_CODE,
		Message:    utils.PRODUCT_ATTRIBUTES_REQUIRED_MSG,
		StatusCode: http.StatusBadRequest,
	}

	ErrUnauthorizedProductAccess = &commonError.AppError{
	...
	ErrInvalidStrategy = &commonError.AppError{
