...
const (
	FAILED_TO_RECORD_RECENTLY_VIEWED_MSG = "Failed to record recently viewed product"
	FAILED_TO_TRIM_RECENTLY_VIEWED_MSG   = "Failed to trim recently viewed products"
	RECENTLY_VIEWED_RETRIEVED_MSG        = "Recently viewed products retrieved"
	FAILED_TO_GET_RECENTLY_VIEWED_MSG    = "Failed to retrieve recently viewed products"
)
