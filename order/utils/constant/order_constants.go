...
const (
	ORDER_CREATED_MSG        = "Order placed successfully"
	ORDER_FETCHED_MSG        = "Order fetched successfully"
...
const (
	FAILED_TO_CREATE_ORDER_MSG        = "Failed to create order"
	FAILED_TO_FETCH_ORDER_MSG         = "Failed to fetch order"
