...
// GetOrderHistoryRepository returns the singleton order history repository
func (f *RepositoryFactory) GetOrderHistoryRepository() repository.OrderHistoryRepository {
	f.initialize()
