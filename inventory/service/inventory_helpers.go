...
// ============================================================================
// Inventory Helper (Stateless validation and calculation helpers)
// ============================================================================

// InventoryHelper provides helper methods for inventory operations
type InventoryHelper struct{}

// NewInventoryHelper creates a new instance of InventoryHelper
func NewInventoryHelper() *InventoryHelper {
	return &InventoryHelper{}
}

// ValidateManageRequest validates the manage inventory request
func (h *InventoryHelper) ValidateManageRequest(req model.ManageInventoryRequest) error {
...
func (h *InventoryHelper) CalculateQuantityChange(
	...
	case entity.TXN_ADJUSTMENT:
		return h.calculateAdjustmentChange(req, isNewInventory)
...
func (h *InventoryHelper) calculateAdjustmentChange(
	req model.ManageInventoryRequest,
	isNewInventory bool,
) (int, error) {
	if isNewInventory {
...
func (h *InventoryHelper) ApplyInventoryChanges(
	...
	if updatesReserved {
		return h.applyReservedQuantityChange(inventory, quantityChange)
	}
	return h.applyQuantityChange(inventory, req, quantityChange)
}

// applyReservedQuantityChange applies changes to reserved quantity
func (h *InventoryHelper) applyReservedQuantityChange(
	inventory *entity.Inventory,
	quantityChange int,
) error {
...
func (h *InventoryHelper) applyQuantityChange(
	inventory *entity.Inventory,
	req model.ManageInventoryRequest,
	quantityChange int,
) error {
...
func (h *InventoryHelper) UpdateThreshold(inventory *entity.Inventory, threshold *int) {
	if threshold != nil {
...
func (h *InventoryHelper) BuildManageResponse(
	inventory *entity.Inventory,
...
func (h *BulkInventoryHelper) ExtractUniqueLocationIDs(items []model.ManageInventoryRequest) []uint {
...
func BuildFailureResult(item model.ManageInventoryRequest, errorMsg string) model.BulkInventoryItemResult {
