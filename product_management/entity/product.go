...
type Product struct {
	...
	CategoryID       uint     `json:"categoryId" binding:"required" gorm:"column:categoryId"`
	...
	LongDescription  string   `json:"longDescription" gorm:"column:longDescription"`
	Images           []string `json:"images" gorm:"column:images;type:text[]"`
	InStock          bool     `json:"inStock" gorm:"column:inStock;default:true"`
	IsPopular        bool     `json:"isPopular" gorm:"column:isPopular;default:false"`
